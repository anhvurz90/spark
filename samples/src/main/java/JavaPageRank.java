...
/**
 * Computes the PageRank of URLs from an input file. Input file should be in format of:
 * URL  neighbor URL
 * URL  neighbor URL
 * URL  neighbor URL
 * ...
...
public class JavaPageRank {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> lines = sSession.read().textFile(args[0]).javaRDD();
        ...
        // Loads all URLs with other URL(s) link to from input file and initialize ranks of then to one
